...
import { validateGetCustomersQuery } from 'middlewares/validations'

const customerRouter = Router()

customerRouter.get('/', auth, roleGuardMiddleware(Role.Admin), validateGetCustomersQuery, getCustomers)
